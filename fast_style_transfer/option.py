...
class Options():
    def __init__(self):
        ...
        demo_arg.add_argument("--style-folder", type=str, default="fast_style_transfer/images/21styles/",
                                help="path to style-folder")
        ...
        demo_arg.add_argument("--video-file", type=str, default=None,
                                help="Video file")
        demo_arg.add_argument("--tau", type=int, default=2,
                                help="Smoothness")
        demo_arg.add_argument("--style-a", type=int, default=0,
                                help="Style id a")
        demo_arg.add_argument("--style-b", type=int, default=None,
                                help="Style id b")
