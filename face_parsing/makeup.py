...
def hair(image, parsing, part=17, color=[230, 50, 20]):
    ...
    if part == 12 or part == 13 or part == -17:
...
if __name__ == '__main__':
    ...
    image_path = '../images/lucas_profile.jpg'
    parsing_path = 'res/lucas_profile.png'
    ...
    cv2.imwrite('res/116_ori.png', cv2.resize(ori, (512, 512)))
    cv2.imwrite('res/116_2.png', cv2.resize(image, (512, 512)))

    cv2.imshow('image', cv2.resize(ori, (512, 512)))
    cv2.imshow('color', cv2.resize(image, (512, 512)))

    """     styled = cv2.resize(cv2.imread('../images/lucas_starry.png'), (512,512))
    image[parsing == 0] = styled[parsing == 0]
